...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of MGVideoPlayerKit.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/AldoOS/MGVideoPlayerKit'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'AldoOS' => 'harald.bregu@gmail.com' }
  s.source           = { :git => 'https://github.com/AldoOS/MGVideoPlayerKit.git', :tag => s.version.to_s }
